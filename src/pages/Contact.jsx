            ...
            <div className="contact row-cols-1 row row-cols-md-2 mt-5 mb-5 shadow rounded-3">
                ...
                <form className="form col pt-4 ps-4">
                    <fieldset>
                        ...
                        <div className="">
                            <input type="name" className="rounded-2 mb-2" id="formName" placeholder="Votre nom" required/>
                        </div>
                        <div>
                            <input type="mail" className="rounded-2 mb-2" id="formMail" placeholder="Votre adresse mail" required/>
                        </div>
                        <div>
                            <input type="tel" className="rounded-2 mb-2" id="formTel" placeholder="Votre numéro de téléphone" required/>
                        </div>
                        <div>
                            <input type="objet" className="rounded-2 mb-2" id="formObjet" placeholder="Sujet" required/>
                        </div>
                        <div>
                            <textarea className="rounded-2 mb-2" id="formMessage" rows="12" placeholder="Votre message" required></textarea>
                        </div>
                    </fieldset>
                    <div className="d-flex column flex-column justify-content-center align-items-center">
                        <input type="submit" value="Envoyer" className="btn btn-primary mb-5 mt-2"/>
                    </div>
                ...
                <div className="contact-detail col pt-4 pe-4">
                    ...
                    <img src="/adresse.png" alt="adresse" className="mt-3 pb-4"/>
                </div>
            </div>
        </div>
    </main>
